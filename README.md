...
We posit that **probabilistic alignment with ICL is a key desideratum** for effective task vector (tv) extraction methods, and accordingly propose **d<sub>NTP</sub>**(`run/run_our_metric.sh`) and **Linear Task Vector (LTV)**(`run/run_our_ltv.sh`). The figure below provides an overview of LTV.

### - Metric: d<sub>NTP</sub>
<p align="center">
  <img src="assets/metric.png" alt="d_NTP method" width="450">
</p>
